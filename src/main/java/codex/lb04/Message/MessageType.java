...
public enum MessageType {
    ...
    UPDATE_RESOURCE, UPDATE_HAND, UPDATE_COMMON_OBJECTIVES, UPDATE_INITIAL_CARD_DISPLAY, UPDATE_SECRET_OBJECTIVE_TO_CHOOSE, WINNERS                         //message sent to all players to show the winners
}